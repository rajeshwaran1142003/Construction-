        ...
        <div className="text-center max-w-4xl mx-auto px-6">
          <div className="animate-fade-in-up">
            <h1 className="text-white text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-bold leading-tight mb-6">
              Services & <span className="text-emerald-400">Projects</span>
            </h1>
            <p className="text-gray-200 text-lg sm:text-xl md:text-2xl font-medium leading-relaxed mb-8 max-w-3xl mx-auto">
              Comprehensive construction and engineering solutions delivered with precision, innovation, and unwavering commitment to excellence.
            </p>
            <div className="flex flex-col sm:flex-row items-center justify-center gap-6">
              <div className="flex items-center gap-3 text-emerald-300">
                <div className="w-3 h-3 bg-emerald-400 rounded-full animate-pulse"></div>
                <span className="text-lg font-semibold">6 Core Services</span>
              </div>
              <div className="flex items-center gap-3 text-emerald-300">
                <div className="w-3 h-3 bg-emerald-400 rounded-full animate-pulse"></div>
                <span className="text-lg font-semibold">Major Projects</span>
              </div>
              <div className="flex items-center gap-3 text-emerald-300">
                <div className="w-3 h-3 bg-emerald-400 rounded-full animate-pulse"></div>
